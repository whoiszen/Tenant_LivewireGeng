<div class="container-fluid py-5">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <!-- Hamburger Button -->
                <button class="btn btn-outline-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#filterSidebar" aria-controls="filterSidebar">
    ...
    <div class="row">
        ...
        <div class="offcanvas offcanvas-start d-md-none" tabindex="-1" id="filterSidebar" aria-labelledby="filterSidebarLabel" style="max-height: 100vh; overflow-y: auto;">
            ...
            <div class="offcanvas-body" style="max-height: calc(100vh - 70px); overflow-y: auto;">
                <!-- Location Filter -->
                <div class="mb-3">
